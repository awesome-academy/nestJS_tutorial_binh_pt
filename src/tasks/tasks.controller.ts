...
export class TasksController {
  ...
  createTask(
    ...
    return this.tasksService.createTask(taskParams, req.user).then((value) => {
      return { message: i18n.t('task.create.success'), data: value };
    });
  }
  ...
  deleteTaskById(
    ...
    return this.tasksService
      .deleteTaskById(id, req.user)
      .then(() => {
        return { message: i18n.t('task.delete.success', { args: { id: id } }) };
      })
      .catch((error) => {
        throw error;
      });
  ...
  updateTaskStatus(
    ...
    return this.tasksService
      .updateTaskStatus(id, !!active, req.user)
      .then(() => {
        return { message: i18n.t('task.update.success', { args: { id: id } }) };
      })
      .catch((error) => {
        throw error;
      });
